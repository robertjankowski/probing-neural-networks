...
def main(iteration):
    ...
    hard_classes_to_select = [class1_hard, class2_hard]
    num_classes_hard = len(hard_classes_to_select)

    hard_train_loader, hard_test_loader = load_fashion_mnist_subset(
    ...
    print("Training model on the hard task (Sandal vs Sneaker)...")
    ...
    easy_classes_to_select = [class1_easy, class2_easy]
    num_classes_easy = len(easy_classes_to_select)

    easy_train_loader, easy_test_loader = load_fashion_mnist_subset(
        batch_size=batch_size,
    ...
    print("\nTraining model on the easy task (Pullover vs Sneaker)...")
